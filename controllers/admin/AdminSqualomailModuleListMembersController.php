...
/**
 * Class AdminSqualomailModuleListMembersController
 */
class AdminSqualomailModuleListMembersController extends \PrestaChamps\SqualomailModule\Controllers\BaseSQMObjectController
{
    ...
    protected function getPaginationPageLinkTemplate()
    {
         ...
         *
         * The method exits in modules/squalomailmodule/src/LinkHelper.php
         */
        return urldecode(
