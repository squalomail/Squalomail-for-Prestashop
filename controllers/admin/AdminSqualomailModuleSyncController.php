...
/**
 * Class AdminSqualomailModuleSyncController
 *
 * @property Squalomailmodule $module
 */
class AdminSqualomailModuleSyncController extends ModuleAdminController
{
    ...
    public function processPromoCodeSync()
    {
        try {
            ...
            $service = new \PrestaChamps\SqualomailModule\Commands\CartRuleSyncCommand(
                $this->context,
                $this->module->getApiClient(),
                $items
            );
    ...
    public function processOrderSync()
    {
        try {
            $method = Tools::getValue('method', 'post');
            $service = new \PrestaChamps\SqualomailModule\Commands\OrderSyncCommand(
                $this->context,
                $this->module->getApiClient()
            );
            if ($method === 'post') {
    ...
    public function processCustomerSync()
    {
        ...
        try {
            ...
            $service = new \PrestaChamps\SqualomailModule\Commands\CustomerSyncCommand(
                $this->context,
                $this->module->getApiClient(),
                $customerIds
            );
