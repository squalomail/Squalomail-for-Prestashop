...
/**
 * A SqualoMail Batch operation.
 * http://developer.squalomail.com/documentation/squalomail/reference/batches/
 *
...
class Batch
{
    ...
    public function __construct(SqualoMail $SqualoMail, $batch_id = null)
    {
    ...
    public function execute($timeout = 10)
    {
        ...
        $result = $this->SqualoMail->post('batches', $req, $timeout);
    ...
    public function check_status($batch_id = null)
    {
        ...
        return $this->SqualoMail->get('batches/' . $batch_id);
    }
