...
namespace DrewM\SqualoMail;

/**
 * Super-simple, minimum abstraction SqualoMail API v3 wrapper
 * SqualoMail API v3: http://developer.squalomail.com
 * This wrapper: https://github.com/drewm/squalomail-api
 *
...
{
    const TIMEOUT = 10;
    static $USER_AGENT = 'DrewM/SqualoMail-API/3.0 (github.com/drewm/squalomail-api)';
    /**
    ...
    protected $api_key;
    protected $api_endpoint = 'https://api.squalomail.com/mc/v3';

    /**
     * Create a new instance
     *
     * @param string $api_key Your SqualoMail API key
     ...
     *
     * Squalomail only implements the URI reference and relation type from
     * RFC 5988, so the value of the header is something like this:
     *
     * 'https://us13.api.squalomail.com/schema/3.0/Lists/Instance.json; rel="describedBy",
     * <https://us13.admin.squalomail.com/lists/members/?id=XXXX>; rel="dashboard"'
     *
