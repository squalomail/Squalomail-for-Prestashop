...
<tr>
    ...
    <td>
        ...
        {else}
            <span class="text-danger">{l s='No customer' mod='squalomailmodule'}</span>
        {/if}
    </td>
    <td>
    ...
    <td>
        <a href="{$link->getAdminLink('AdminSqualomailModuleOrders', true, [], ['action' => 'entitydelete', 'entity_id' => $order.id])|escape:'htmlall':'UTF-8'}">
            Delete
        </a>
    </td>
</tr>
